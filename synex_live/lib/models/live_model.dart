...
class LiveModel {
  ...
  LiveModel copyWith({
    List<String>? speakers, List<String>? blockedUsers,
    List<String>? mutedSpeakers, bool? isLive, int? viewerCount, DateTime? endedAt,
  }) => LiveModel(
    id: id, hostId: hostId, hostName: hostName, title: title,
    hostPhotoUrl: hostPhotoUrl, description: description,
    ...
    startedAt: startedAt, endedAt: endedAt ?? this.endedAt,
  );
}
