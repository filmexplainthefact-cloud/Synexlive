...
class AuthService extends ChangeNotifier {
  ...
  Future<void> _fetch(String uid) async {
    ...
    } catch (e) { debugPrint('fetch user error: $e'); }
  }
  ...
  Future<String?> signInWithGoogle() async {
    try {
      ...
      if (gUser == null) return 'Sign in cancelled';
      ...
      return null;
    } catch (e) { return 'Google sign in failed: $e';
    } finally { _loading = false; notifyListeners(); }
  }
  ...
  Future<String?> updateProfile({String? name, String? bio, String? photoUrl}) async {
    try {
      final uid = currentUserId; if (uid == null) return 'Not authenticated';
  ...
  Future<void> updateFcmToken(String token) async {
    ...
    await _db.collection(AppConstants.usersCollection).doc(uid).update({'fcmToken': token});
  }
