// WebRTC Service - Stub version for build compatibility
// Full WebRTC will be enabled after proper native setup
class WebRTCService {
  ...
  Future<void> disconnectPeer(String userId) async {}
}
